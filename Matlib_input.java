...
public class MadLibsInputStory {
    public static void main(String[] args) {
        ...
        while ((index=story.indexOf("[NAME]")) !=-1 {   // replaces name in the template the user inputted above. It would run through the input to find the name and returns -1 if it does not find it 
            story=story.substring(0,index) + name + story.substring.(index+6); // the (0,index) is everything before the place of the [NAME] and the following (index+6) is everything after the [NAME]
